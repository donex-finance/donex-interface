...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'app.donex.finance', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.donex.finance', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.donex.finance', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'app.donex.finance', pathname: '/asset.gif' } }, false],
